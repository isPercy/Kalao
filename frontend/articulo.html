          ...
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link px-3 dropdown-toggle text-white" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Categorias</a>
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="categorias.html">Departamentos</a></li>
                  <li><a class="dropdown-item" href="categorias.html">Deportes</a></li>
                  <li><a class="dropdown-item" href="categorias.html">Electrodomésticos</a></li>
                  <li><a class="dropdown-item" href="categorias.html">Inmuebles</a></li>
                  <li><a class="dropdown-item" href="categorias.html">Moda</a></li>
                  <li><a class="dropdown-item" href="categorias.html">Tecnología</a></li>
                  <li><a class="dropdown-item" href="categorias.html">Vehículos</a></li>
                  <li><a class="dropdown-item" href="categorias.html">Viviendas</a></li>
                </ul>
              </li>
              
              <li><a href="carro.html" class="nav-link px-3 text-white">Carro</a></li>
              <li><a href="help.html" class="nav-link px-3 text-white">Ayuda</a></li>
            </ul>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-12 mt-5">
          <h1 class="page-header">Tableta digital Wacom Bamboo</h1>
        </div>
      </div>
      <!-- /.row -->
              ...
              <div id="product-carousel" class="carousel slide">
                <div class="carousel-inner" role="listbox">
                  <div class="carousel-item active">
                    <img id="first-image" src="https://cdnx.jumpseller.com/bootstrap/image/14896546/grey-bamboo.jpg?1614272621" srcset="https://cdnx.jumpseller.com/bootstrap/image/14896546/grey-bamboo.jpg?1614272621" alt="Wacom Bamboo Tablet" class="img-fluid">
                  </div>
                  
                  <div class="carousel-item"><img src="https://cdnx.jumpseller.com/bootstrap/image/1072447/resize/540/675?1614272621" srcset="https://cdnx.jumpseller.com/bootstrap/image/1072447/resize/540/675?1614272621 1x, https://cdnx.jumpseller.com/bootstrap/image/1072447/resize/1080/1350?1614272621 2x" alt="Wacom Bamboo Tablet"></div>
                  
                  <div class="carousel-item"><img src="https://cdnx.jumpseller.com/bootstrap/image/14896546/resize/540/675?1614272621" srcset="https://cdnx.jumpseller.com/bootstrap/image/14896546/resize/540/675?1614272621 1x, https://cdnx.jumpseller.com/bootstrap/image/14896546/resize/1080/1350?1614272621 2x" alt="Wacom Bamboo Tablet"></div>
        ...
        <div class="col-lg-6">
          <form class="form-horizontal" action="/cart/add/224300" method="post" enctype="multipart/form-data" name="buy">
              ...
              <div class="form-group product-stock product-out-stock row hidden">
                ...
                <div class="col-sm-8 col-md-9">
                  <span class="product-form-price">Reservado</span>
                  <p>This product has run out of stock. You may send us an inquiry about it.</p>
                  <a href="#" class="btn btn-secondary btn-sm" title="Contact Us">Contactate con nosotros en</a>
                  <a href="javascript:history.back()" class="btn btn-link btn-sm" title="← or Continue Shopping">Continuar comprando</a>
                </div>
              </div>
              ...
              <div class="form-group product-stock product-available row visible">
                ...
                <div class="col-sm-8 col-sm-offset-3 col-md-9 col-md-offset-3">
                  ...
                  <input type="submit" class="adc btn btn-primary" value="Agregar al carrito de compra">
                  
    
    
                  <a href="javascript:history.back()" class="btn btn-link btn-sm" title="Continue Shopping">Continuar comprando</a>
                </div>
              </div>
